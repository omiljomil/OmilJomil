...
/**
 * Servlet implementation class CheckEmailSerlvet
 */
@WebServlet("/checkEmail.me")
public class CheckEmailSerlvet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CheckEmailSerlvet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      //인증 번호 생성기
        ...
        JSONObject ceNum = new JSONObject();
        ceNum.put("key", AuthenticationKey);
