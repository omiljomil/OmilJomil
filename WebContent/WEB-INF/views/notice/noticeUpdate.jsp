    ...
    <section>
      ...
      <div id="notice-table">
        <table>
            ...
            <tr>
                <th>제목</th>
                <th><input type="text" id="notice-text-title" placeholder="제목 입력" name="title" value="<%=request.getAttribute("title") %>"></th>
            </tr>
            <tr>
                <th>작성자</th>
            ...
            <tr>
                <th>작성일</th>
                <th ><input type="date" name="date" value="<%=request.getAttribute("date")%>"></th>
            </tr>
        </table>
        <input type="hidden" name="no"  value= "<%=request.getAttribute("no") %>" id="num">
      </div>
   

    
     <div id="notcie-content">  
        <textarea id="content" name="content" cols="150" rows="21" placeholder="이미지%내용입력"><%=request.getAttribute("content") %></textarea>
      </div> 
