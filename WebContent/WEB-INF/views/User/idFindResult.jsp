...
<body>
	...
	<div class="name_email">
		<label style="font-weight: bold;"><%=request.getAttribute("userName") %> / <%=request.getAttribute("email") %></label> 으로 찾는 아이디입니다.
	</div>
		<h3>고객님 아이디 찾기가 완료 되었습니다.</h3>
		<div class="seartext">
			<div class="id_name">
			<label style="font-weight: bold;"><%=request.getAttribute("userId") %> </label><label>회원 아이디 출력</label>
			</div>
			<div class="id_email">
				즐거운 쇼핑하세요!
			</div>
