...
<%@ include file = "../common/myPage.jsp" %>
		...
		<div class="order"><span class="h4" style="font-size: 16px; font-weight: bold;">주문 처리 현황</span><span class="h5" style="font-size: 13px;">(최근 3개월 기준)</span></div>
			<div class="orderSub">
				<table class="order_table">
					<tr>
						<td width="105" height="40" style="border-right: 1px solid #E2E2E2">입금 대기</td>
						<td width="105" height="40" style="border-right: 1px solid #E2E2E2">결제 완료</td>
			...
			<div class="zzim">
				...
				<table>
					<tr>
						<td rowspan="3" width="150px" height="40px" style="border: 1px solid #E2E2E2"></td>
			...
			<div class="look">
				...
				<table>
					<tr>
						<td width="200px" height="130px" style="border-right: 1px solid #E2E2E2"></td>
						<td width="200px" height="130px" style="border-right: 1px solid #E2E2E2"></td>
						<td width="200px" height="130px" style="border-right: 1px solid #E2E2E2"></td>
						<td width="200px" height="130px" style="border-right: 1px solid #E2E2E2"></td>
					</tr>
