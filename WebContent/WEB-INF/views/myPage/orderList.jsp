...
<body>
	...
	<div class="order_ship">
		...
		<ul class="order_search">
			<li><input type="text" id="product_search" size="53"
				maxlength="20" height="50px;" placeholder="주문한 상품을 검색해 보세요"></li>
		</ul>

		<%@ include file="../myPage/dateCheck.jsp"%>
		<div class="order_product_title"
			style="width: 100%; position: relative; text-align: left;">
			<p>주문 상품 정보</p>
		</div>
		<ul>
