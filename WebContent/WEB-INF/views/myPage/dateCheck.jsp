...
<body>
					 ...
					 <form method="get" name="frmDateSearch" class="order_form" autocomplete="off">
						<table class="ship_table">
							<tr>
								...
								<td id="order_search"><input type="text" id="startDate1"style="font-size: small" autocomplete='off'/></td>
								<td id="order_search" width=5px; height=30px style="font-size: small">~ </td>
								<td id="order_search" width=20px; height=30px><input type="text" id="endDate1"style="font-size: small" autocomplete='off'/></td>
